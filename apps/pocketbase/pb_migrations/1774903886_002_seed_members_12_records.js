...
migrate((app) => {
  ...
  const record4 = new Record(collection);
    ...
    record4.set("mobile_number", "9999999999");
  ...
  const record5 = new Record(collection);
    ...
    record5.set("mobile_number", "9999999998");
  ...
  const record6 = new Record(collection);
    ...
    record6.set("mobile_number", "9999999997");
  ...
  const record7 = new Record(collection);
    ...
    record7.set("mobile_number", "9999999996");
  ...
  const record8 = new Record(collection);
    ...
    record8.set("mobile_number", "9999999995");
  ...
  const record9 = new Record(collection);
    ...
    record9.set("mobile_number", "9999999994");
  ...
  const record10 = new Record(collection);
    ...
    record10.set("mobile_number", "9999999993");
  ...
  const record11 = new Record(collection);
    ...
    record11.set("mobile_number", "9999999992");
