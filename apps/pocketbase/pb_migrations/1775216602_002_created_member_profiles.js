...
migrate((app) => {
  ...
  const collection = new Collection({
    ...
    "id": "pbc_8458401799",
    "indexes": [],
    "listRule": "approval_status = \"approved\" && directory_visible = true",
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_8458401799");
